...
if(isset($_SESSION['email']) && isset($_SESSION['password'])){
 ...
 //  echo "<a href='page4.php'> logout</a> ";
  // echo " <a href='page3.php'> page3 </a>";
    ...
    echo " <p style='color:yellow; font-size:20px;'><b>please SIGNUP bro </b><a href='home.php' style='color:white;font-size:30px;'> Home</a></p> ";
...
<h2 style="position: relative;left:570px;font-size: 70px;top:-50px;">SignUp Form</h2>

<form id="form11"  action = "signup1.php" method="POST" style="background-color:rgba(255, 255, 255, 0.54);">
  ...
  <div class="container">
    ...
    <label id="password1"></label>
         <br></a><br><br><br>
    <button type="submit" onclick="validateform();">SIGNUP</button>
  <label  id="form1"></label>
  </div>
<br><br>
<a href="login.php" style="position: relative;left:440px; font-size: 25px;"><b>else Login?</b>
