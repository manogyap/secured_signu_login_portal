	...
	<div class="login-form-1">
		<form id="forgot-password-form" class="text-left"  action="mail.php" method="POST">
			<div class="etc-login-form">
				<p>When you fill in your registered email address, you will be sent a link on your given email id.</p>
			</div>
			...
			<div class="main-login-form">
				<div class="login-group">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="email" name="email" onkeyup="validateemail();" placeholder="email address">
